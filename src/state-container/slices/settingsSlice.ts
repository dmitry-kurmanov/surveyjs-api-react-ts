...
export function setLocaleReducer(state: ISettingsState, action: PayloadAction<string>) {
...
export function setThemeReducer(state: ISettingsState, action: PayloadAction<string>) {
